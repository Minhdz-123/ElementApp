...
// Lớp đại diện cho một nguyên tố hóa học
class Element {
    ...
    public void displayInfo() {
        System.out.println("STT: " + atomicNumber);
        System.out.println("name: " + name);
        System.out.println("Symbol: " + symbol);
        System.out.println("Khoi luong mol(M): " + molarMass + " g/mol");
    }
}

// Lớp chính để tra cứu nguyên tố hóa học
public class ElementLookup {
    ...
    void display() {
        ...
        System.out.print("WELCOME to ElementLookup");
